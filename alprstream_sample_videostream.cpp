...
int main(int argc, char** argv) {
  ...
  const std::string VIDEO_STREAM_URL = "rtsp://username:password@192.168.0.1/axis-media/media.amp?fps=10&resolution=1280x720";
  ...
  while (true)
  {
    ...
    StreamStatData stats = alpr_stream.getStats();
    cout << "Streaming: " << stats.is_streaming << endl;
